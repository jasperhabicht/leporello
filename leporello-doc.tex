...
\makedoctitle
  ...
  {Jasper Habicht}[E-mail: \href{mailto:mail@jasperhabicht.de}{mail@jasperhabicht.de}. The title image was generated using ChatGPT.]
  {Version \leporellofileversion, released on \leporellofiledate}

\changes{v0.7.0}{2025/08/08}{First public beta release.}
\changes{v0.8.0}{2025/08/12}{Added option to place arbitrary code to box background.}

\begin{document}
\vspace*{-3em}%
\noindent\hspace{-5pt}%
\includegraphics[width=75mm]{doc/leporello.pdf}
