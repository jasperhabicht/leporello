...
\changes{v1.0.1}{2025/08/30}{Fix of a bug that prevented the dimensions set with \titlemacro{store width} or \titlemacro{store height} from having the correct value when used as value to the \titlemacro{offset} key. Fix of a bug in the stretch mechanism. Fix of a bug in right-to-left typesetting.}
...
\l_leporello_reverse_layout_bool
\l_leporello_reverse_order_bool
\l_leporello_reverse_pagination_bool

\l_leporello_layout_vertical_ltr_bool
\l_leporello_layout_vertical_rtl_bool

\l_leporello_auto_typeset_bool
\l_leporello_continuous_pagination_bool
...
\l_leporello_notes_list_str

\leporello_draw_absolute:nn
\leporello_typeset_image:nn
\leporello_typeset_columns:nn
\leporello_typeset_columns:nV

\leporello_fp_tuple_use_i:n
\leporello_fp_tuple_use_i:e
\leporello_fp_tuple_use_ii:n
\leporello_fp_tuple_use_ii:e

\leporello_note_mark:n

Compatibility:

\leporello_ltlayout_paperwidth_set:n
\leporello_ltlayout_paperheight_set:n
\leporello_ltlayout_textwidth_set:n
\leporello_ltlayout_textheight_set:n
\leporello_ltlayout_topmargin_set:n
\leporello_ltlayout_oddsidemargin_set:n
\leporello_ltlayout_evensidemargin_set:n
\leporello_ltlayout_hoffset_set:n
\leporello_ltlayout_voffset_set:n
\leporello_ltlayout_headheight_set:n
\leporello_ltlayout_headsep_set:n
\leporello_ltlayout_footskip_set:n
\leporello_ltlayout_marginparwidth_set:n
\leporello_ltlayout_marginparsep_set:n
\leporello_ltlayout_marginparpush_set:n

\leporello_pagestyle_set:n
 = \pagestyle{#1}
