...
\begin{macrodef}
|\l_leporello_tex_baselineskip_skip|
...
\end{macrodef}
These commands set the relevant TeX dimension to the argument given. To give an example, \newline \macro{\leporello_tex_hoffset_set:n { 1in }} sets \macro{\hoffset} to 1in. These commands also have a ...\macro{_gset:n} and a ...\macro{_add:n} variant as well as a ...\macro{_zero:} variant.
...
\end{macrodef}
These commands set the relevant LaTeX dimension to the argument given. These commands also have a ...\macro{_gset:n} variant that sets the dimension globally. The command \newline \macro{\leporello_latex_colht_set:n} sets \macro{\@colht}.
