...
\end{macrodef}
These variables hold the ID of the current sheet page in the PDF file), the current page (column in the document), the current column (column on the sheet) and the current box as integer respectively.
