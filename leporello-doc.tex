...
\def\leporellofileversion{1.0.4}
\def\leporellofiledate{24 September 2025}
...
\changes{v1.0.4}{2025/09/24}{Unified naming of compatibility commands.}
...
|\leporello_par:|
\end{macrodef}
This command is an alias for \macro{\par}.
