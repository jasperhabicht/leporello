...
|\leporello_latex_hoffset_set:n| {<dimension>}
|\leporello_latex_voffset_set:n| {<dimension>}
|\leporello_latex_headheight_set:n| {<dimension>}
|\leporello_latex_headsep_set:n| {<dimension>}
|\leporello_latex_footskip_set:n| {<dimension>}
|\leporello_latex_marginparwidth_set:n| {<dimension>}
|\leporello_latex_marginparsep_set:n| {<dimension>}
|\leporello_latex_marginparpush_set:n| {<dimension>}
|\leporello_latex_linewidth_set:n| {<dimension>}
|\leporello_latex_colht_set:n| {<dimension>}
\end{macrodef}
These commands set the relevant LaTeX dimension to the argument given. To give an example, \macro{\leporello_latex_paperwidth_set:n { 297mm }} sets \macro{\paperwidth} to 297mm. These commands also have a ...\macro{_gset:n} variant that sets the dimension globally. The command \newline \macro{\leporello_latex_colht_set:n} sets \macro{\@colht}.
...
\end{macrodef}
These commands set the relevant TeX dimension to the argument given. These commands also have a ...\macro{_gset:n} and a ...\macro{_add:n} variant as well as a ...\macro{_zero:} variant.

\begin{macrodef}
|\leporello_tex_topskip_zero:|
|\leporello_tex_parfillskip_zero:|
\end{macrodef}
These commands set the relevant TeX dimension to zero.

\begin{macrodef}
|\l_leporello_tex_baselineskip_dim|
|\l_leporello_tex_pagegoal_dim|
|\l_leporello_tex_pagetotal_dim|
\end{macrodef}
These token variables are aliases for \macro{\baselikeskip}, \macro{\pagegoal} and \macro{\pagetotal}.

\begin{macrodef}
|\c_leporello_tex_par_tl|
\end{macrodef}
This token variable is an alias for \macro{\par} (more exactly for \macro{\tex_par:D}).
...
\begin{macrodef}
|\l_leporello_luatex_bodydirection_int|
\end{macrodef}
This token variable is an alias for \macro{\bodydirection}. If LuaTeX is not used, its value is 0.
